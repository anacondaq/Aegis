...
jobtbl = {	
	...
	JT_E_B_SEYREN = 2112,
	JT_E_B_EREMES = 2113,
	-- 이후에 추가되는 JT에 대해서 위와 같은 형식으로 넘버링 해주세요~
	-- 몬스터를 추가할때는 항상 맨 뒤에 오게 해야한다. 이 뒤로는 다른 것 금지.
	--정령몬스터추가
	JT_EL_AGNI_S    = 2114,
	JT_EL_AGNI_M	= 2115,
	JT_EL_AGNI_L	= 2116,
...
--2010-07-21일본 여름 이벤트 카피몬스터	
	...
	JT_LEAK						= 2156,
	JT_G_BANASPATY				= 2157,	
	--2010-10-6	호문S_서몬레기온에서 호출될 문스터 추가
	JT_S_HORNET					= 2158,
	JT_S_GIANT_HORNET			= 2159,
	JT_S_LUCIOLA_VESPA			= 2160,
	--2010-10-6 일본 스카바라홀 추가몬스터
	...
	-- 스킬 끝 NPC 추가하는곳 Second
	-- NPC 추가하는곳 Second
	-- NPC 스프라이트 번호가 699를 넘어가게 되면 새로운 번호를 할당하여 작업하여야 한다.
	-- NPC 추가하는곳	
	JT_WARPNPC = 45,
	JT_1_ETC_01 = 46,
	JT_1_M_01 = 47,
